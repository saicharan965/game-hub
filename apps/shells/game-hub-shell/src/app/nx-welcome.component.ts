      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build game-hub-shell
<span># Test</span>
nx test game-hub-shell
<span># Lint</span>
nx lint game-hub-shell
<span># Run them together!</span>
nx run-many -p game-hub-shell -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project game-hub-shell</pre>
          </details>
