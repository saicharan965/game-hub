...
@Component({
  selector: 'game-hub-snake-master-nx-welcome',
  standalone: false,
  template: `
    <!--
     * * * * * * * * * * * * * * * * * * * * * * * * * * * *
      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build snake_master
<span># Test</span>
nx test snake_master
<span># Lint</span>
nx lint snake_master
<span># Run them together!</span>
nx run-many -p snake_master -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project snake_master</pre>
          </details>
